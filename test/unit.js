    ...
    : describe("lottery Unit Tests", function () {
          ...
          describe("enterlottery", function () {
              ...
              it("emits event on enter", async () => {
                  await expect(lottery.enterlottery({ value: lotteryEntranceFee })).to.emit( // emits lotteryEnter event if entered to index player(s) address
                      lottery,
                      "lotteryEnter"
                  )
              })
              it("doesn't allow entrance when lottery is calculating", async () => {
                  ...
                  await expect(lottery.enterlottery({ value: lotteryEntranceFee })).to.be.revertedWith( // is reverted as lottery is calculating
